...
tell application "Terminal"
	...
	do script "cd /Users/randyrektor/react-baby/backend && source venv/bin/activate && uvicorn src.main:app --reload --port 8000" in newWindow
	...
	do script "cd /Users/randyrektor/react-baby/frontend && npm run dev" in front window
end tell
